# GUI code taken from online source and adapted to make a simple 4 questions MCQ using PHQ 9 questions -
...
class Quiz:
    ...
    # will adapt this function to work with the format - each question gives a score etc.
